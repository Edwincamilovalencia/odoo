...
patch(ListController.prototype, {
    ...
    _injectRetainHeaderIfMissing() {
        ...
        // Oculta chips por defecto para esta vista (evita duplicidad de filtros)
        cp.classList.add("retain-hide-chips");
        ...
        wrapper.innerHTML = `
            <div class="logo-col"><img class="logo" src="/web/static/img/logo.png" alt="Odoo"/></div>
    ...
    _retainReadUI() {
        ...
        if (this._fp && this._fp.selectedDates && this._fp.selectedDates.length) {
            ...
            if (d0) dateFrom = d0.toISOString().slice(0,10);
            if (d1) dateTo = d1.toISOString().slice(0,10);
        } else {
